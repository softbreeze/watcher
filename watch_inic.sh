...
if [[ -f "$INSTALL_DIR/watcher.sh" ]] && [[ -f "$INSTALL_DIR/camera.sh" ]] && [[ -f "$INSTALL_DIR/inf.sh" ]] && [[ -f "$INSTALL_DIR/kill_soft2.sh" ]] && [[ -f "$INSTALL_DIR/screenshot.sh" ]] && [[ -f "$INSTALL_DIR/send_later.sh" ]] && [[ -f "$INSTALL_DIR/send_later_command.sh" ]] && [[ -f "$INSTALL_DIR/stop.sh" ]] && [[ -f "$INSTALL_DIR/function.sh" ]]
then
	sleep 0
else
	INSTALL=1
